...
namespace :deploy do
  ...
  after :finished, :restart_puma do
    on roles(:web), in: :groups, limit: 3, wait: 10 do
      ...
      execute "docker run -v /tmp/iquan/17430_1/:/tmp/ -v /home/work/17430/shared/public/assets/:/usr/src/app/public/assets/ -v /home/work/17430/shared/log_1/:/usr/src/app/log/  -d --name 17430_1 17430_docker"
      execute "docker rmi 17430_docker:old || echo 1"
    end
  end
end
